#!/usr/bin/env python3
"""
Script de test pour vérifier le système de filtrage IA (version anglaise)
"""

import os
from articles_batch_en_server import fetch_ai_articles_en, validate_article_quality, validate_ai_relevance

def test_ai_filtering_en():
    """Test du système de filtrage IA (version anglaise)"""
    ...
    print("🧪 Test du système de filtrage IA (version anglaise)...")
    
    try:
        # Récupérer les articles
        print("📰 Récupération des articles anglais...")
        articles = fetch_ai_articles_en(newsapi_key, page_size=5)
        print(f"✅ Récupéré {len(articles)} articles anglais")
